        ...
        <body>
            <div class="w3-card-4">
                ...
                <footer class="w3-container w3-purple">
                    <h5>Generated by Guilherme Oliveira in ${d} - [<a href="/">Return</a>]</h5>
                </footer>
...
exports.studentPage = function( aluno, d ){
    ...
    <body>
        <div class="w3-card-4">
            <header class="w3-container w3-teal">
                <h1>Aluno ${aluno.id}
                <a class="w3-btn w3-round w3-grey" href="/alunos/edit/${aluno.id}">Edit</a>
                </h1>
            </header>
    ...
    pagHTML +=     `</ul></div>
            <footer class="w3-container w3-teal">
                <address>Generated by Guilherme Oliveira in ${d} - [<a href="/">Voltar</a>]</address>
            </footer>
        </div>
    </body>
    </html>
